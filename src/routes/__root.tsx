...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Granth Agrawal — Design & Video Studio" },
      { name: "description", content: "Portfolio and studio site of Granth Agrawal — design, motion, and video for brands, creators, and startups." },
